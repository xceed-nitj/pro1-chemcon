    ...
    return (
      ...
      <div className="bg-white container max-w-7xl mx-auto px-5 sm:px-10  lg:px-8 pt-[58px] lg:pt-[10px] pb-5">
                <div className="w-full mx-auto  md:w-[700px] px-4 lg:w-full" >
                    ...
                    For multiple papers by the same  authors, they need to register separately as stated above. <br> An additional late registration fee of Rs. 1000/- applies to all categories after registration deadline
                    </p>
