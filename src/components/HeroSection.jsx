    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center max-w-7xl mx-auto lg:px-8 px-3 mt-[58px] lg:mt-[2px] ">
        <div className=" flex flex-col items-center md:items-start justify-center z-20 py-4 gap-3 ">
          ...
          <button className='flex flex-row animate-bounce mx-auto  ' onClick={props.onClickScroll}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-7 stroke-accent-500 ">
                      ...
                      <p className=" text-accent-500 font-semibold font-serif text-lg ml-1 my-auto">Dates Extended</p>
          </button>
        </div>
