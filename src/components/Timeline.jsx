    ...
    <div className='space-y-16 container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32'>
      ...
      <div className='relative py-5'>
        <div
          ...
          aria-hidden='true'>
          <div className='mx-auto w-1 h-2.5 grow-0 bg-gradient-to-b from-transparent to-blue-100 rounded-t' />
          <div className='mx-auto w-1 grow bg-blue-100' />
          <div className='mx-auto w-1 h-2.5 grow-0 bg-gradient-to-t from-transparent to-blue-100 rounded-b' />
        </div>
        ...
        <ul className='relative space-y-4 pl-10 md:pl-12 lg:pl-0'>
          <li className='relative lg:w-1/2 lg:pr-6 lg:mr-auto'>
            <div className='w-10 md:w-12 absolute top-0 left-0 bottom-0 -translate-x-full flex justify-center mt-5 lg:translate-x-6 lg:left-auto lg:right-0'>
              <div className='w-3 h-3 bg-blue-500 rounded-full ring ring-blue-100 ring-opacity-100 ring-offset-2' />
            </div>
